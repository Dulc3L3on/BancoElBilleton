...
public class GestorCreacionCuenta extends HttpServlet{
    ...
    private GestorParametrosCliente gestorParametros = new GestorParametrosCliente();
    private GestorEnvioEmail gestorEnvioMail = new GestorEnvioEmail();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){
      cuenta=null;            
        ...
        try {
            ...
            if(cuenta!=null){
                gestorEnvioMail.doPost(request, response);                                                                            
            }else{
            ...
            request.getRequestDispatcher("Trabajadores/Gerente/ResultadoCreacionCuenta.jsp").forward(request, response);
