...
CREATE TABLE Cuenta (numeroCuenta int PRIMARY KEY, codigoDueno int NOT NULL, monto int, fechaCreacion varchar(14) );
ALTER TABLE Cuenta ADD FOREIGN KEY (codigoDueno) REFERENCES Cliente (codigo) ; 
...
ALTER TABLE Transaccion ADD FOREIGN KEY (numeroCuentaAfectada) REFERENCES Cuenta (numeroCuenta) ;
ALTER TABLE Transaccion ADD FOREIGN KEY (codigoCajero) REFERENCES Cajero (codigo) ;
...
ALTER TABLE Cambios_Cliente ADD FOREIGN KEY (gerenteACargo) REFERENCES Gerente (codigo);
ALTER TABLE Cambios_Cliente ADD FOREIGN KEY (clienteCambiado) REFERENCES Cliente (codigo);
...
ALTER TABLE Cambios_Cajero ADD FOREIGN KEY (gerenteACargo) REFERENCES Gerente (codigo);
ALTER TABLE Cambios_Cajero ADD FOREIGN KEY (cajeroCambiado) REFERENCES Cajero (codigo);
...
ALTER TABLE Cambios_Gerente ADD FOREIGN KEY (codigoGerente) REFERENCES Gerente (codigo);
